...
#
#     PHX_SERVER=true bin/altabarra start
#
...
if config_env() == :prod do
  ...
  config :altabarra, Altabarra.Repo,
    ssl: [cacertfile: "/etc/ssl/certs/rds-combined-ca-bundle.pem"],
    url: database_url,
  ...
  #
  #     config :altabarra, Altabarra.Mailer,
